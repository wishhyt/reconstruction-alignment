...
'''
["USER: Who is the author of this book?\nAnswer the question using a single word or phrase. ASSIS
TANT: Jairemarie Pomo<|endoftext|>USER: What is the title of this book? ASSISTANT: The Hog Island
 Oyster Lover's Cookbook: A Guide to Choosing and Savoring Oysters, with 40 Recipes<|endoftext|>U
SER: What is the genre of this book? ASSISTANT: Cookbooks, Food & Wine<|endoftext|>USER: Is this 
book related to Cookbooks, Food & Wine? ASSISTANT: Yes<|endoftext|>USER: Is this book related to 
Sports & Outdoors? ASSISTANT: No<|endoftext|>"]                                                  
['USER: Who wrote this book?\nAnswer the question using a single word or phrase. ASSISTANT: McGra
w-Hill<|endoftext|>USER: What is the title of this book? ASSISTANT: Teen Health Course 2 Student 
Activities Workbook<|endoftext|>USER: What is the genre of this book? ASSISTANT: Health, Fitness 
& Dieting<|endoftext|>USER: Is this a fitness book? ASSISTANT: Yes<|endoftext|>']         
'''
...
class LLaVADataset(Dataset):
    ...
    def __init__(self,
        ...
        # 在 __init__ 最后预先尝试打开 image 中的图片，删除无法打开的图片数据
        # valid_list = []
        # from tqdm import tqdm
        # for item in tqdm(self.list_data_dict):
        #     image_file = item['image']
        #     full_path = os.path.join(self.image_root, image_file)
        #     if 'ocr_vqa' not in image_file:
        #         valid_list.append(item)
        #         continue
        #     try:
        #         im = Image.open(full_path).convert('RGB')
        #         # 可选：调用 im.verify() 检查完整性
        #         valid_list.append(item)
        #         # print(f"Valid image found: {full_path}")  # For debugging purposes
        #     except Exception as e:
        #         pass
                # print(f"Removing invalid image file: {full_path}")
        # self.list_data_dict = valid_list
        
        # with open(data_file_path, 'w') as f:
        #     # Save the filtered data back to the file for future reference
